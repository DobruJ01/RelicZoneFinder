...
function generateRawItems(level, s,items)
{
    var ability_odds = [[6,5,4,3],[6,5,4],[6,5]];
    var rarity_odds = [5000,2000,800,300,100,25,8,1];
    var ability_conv = [1,2,3,4];
...
function convertRawItemToPretty(item_list)
{
    var abilities = item_list[2];
    var ability_levels = item_list[3];
    var rarity = item_list[1];
    var relic_level = item_list[0];
    var ab_arr = ["-","-","-","-"];
...
//        }
    ...
    return ([relic_level, rarity_conv[rarity],ab_arr[0],ab_arr[1],ab_arr[2],ab_arr[3],rarity]);
